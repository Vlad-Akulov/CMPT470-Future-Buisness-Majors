...
public class ValidationTest extends AbstractValueTest {
    ...
    // New test 3
    @Test
    public void newlyAddedTest3TargetsValidationHashCode() {
        String val = "test";
        String err = "error";
        
        Validation<String, String> v1 = Validation.valid(val);
        Validation<String, String> e1 = Validation.invalid(err);

        assertThat(v1.hashCode()).isEqualTo(Objects.hashCode(val));
        assertThat(e1.hashCode()).isEqualTo(Objects.hashCode(err));
    }
