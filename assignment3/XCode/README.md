...
XCode: Towards Cross-Language Code Representation with Large-Scale PreTraining
[XCode Article](https://dl.acm.org/doi/epdf/10.1145/3506696)
[XCode Article PDF version](https://dl.acm.org/doi/pdf/10.1145/3506696)
- Slightly different PDF Version of the original article, same dead OneDrive link that was previously mentioned
**Author Names:** Zehao Lin, Guodun Li, Jingfeng Zhang, Yue Deng, Xiangji Zeng, Yin Zhang, Yao Wan
...
| Code Pair | Recall | Precision |
|---|---|---|
|Java-Python|0.937|0.891|
|Python-C++|0.923|0.858|
|C++-C#|0.913|0.861|
|C#-Java|0.918|0.873|

**Author Search:**
Zehao Lin (Zhejiang University):
- [ACM Page](https://dl.acm.org/profile/99659897876)
- [Research Gate Page](https://www.researchgate.net/profile/Zehao-Lin)
- [Google Scholar Page](https://scholar.google.com/citations?user=ptbQQlUAAAAJ&hl=en)
- Can't find GitHub or personal website. There is another user named "LIN-ZeHao" with a GitHub and GitHub Pages site, but this is a different Zehao Lin.

Guodon Li (Zhejiang University):
- [Google Scholar Page](https://scholar.google.com.tr/citations?user=LJSfS5MAAAAJ&hl=ja)
...
Jingfeng Zhang (Zjejiang University):
...
Yue Deng (Zjejiang University):
- [Google Scholar Page](https://scholar.google.com/citations?user=EAJHzjUAAAAJ&hl=en)
- [ACM Page](https://dl.acm.org/profile/99660067437)
  - *Note: Cannot search profile without Premium access*

Xiangji Zeng (Zjiejiang University):
...
Yin Zhang (Zjejiang University):
- [Google Scholar Page](https://scholar.google.com/citations?user=vCoh6tYAAAAJ&hl=en)
- [University Personal Homepage](https://person.zju.edu.cn/en/zhangyin#0)

Yao Wang (Huazhong University of Science and Technology):
- [ACM Page](https://dl.acm.org/profile/99659299327)
...
**[Articles Citing XCode:](https://scholar.google.com/scholar?start=0&hl=en&as_sdt=2005&cites=12902877604779251287&scipsc=)**
- [Towards an understanding of large language models in software engineering tasks](https://link.springer.com/article/10.1007/s10664-024-10602-0)
  - No information for XCode GitHub repository found.
- There is 26 additional articles citing the original XCode article, but I was unable to find anything meaningful that would lead to me discovering the source code for XCode.
